...
-- 유저랭킹조회
SELECT COUNT(*)+1 AS PNT_RANK FROM POINT WHERE PNT_SCORE > ( SELECT PNT_SCORE FROM POINT WHERE PNT_ID='TEST1');
SELECT COUNT(*)+1 AS PNT_RANK FROM POINT WHERE PNT_SCORE > ( SELECT PNT_SCORE FROM POINT WHERE PNT_ID='TEST2');
